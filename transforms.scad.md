...
- [Translation Commands](#translation-commands)
    ...
    - [`down() { ... }`](#down---)
    - [`up() { ... }`](#up---)
    - [`place_copies() { ... }, translate_copies() { ... }`](#place_copies----translate_copies---)
    - [`spread() { ... }, line_of() { ... }`](#spread----line_of---)
    - [`xspread() { ... }`](#xspread---)
    - [`yspread() { ... }`](#yspread---)
    - [`zspread() { ... }`](#zspread---)
    ...
    - [`grid_of() { ... }`](#grid_of---)
- [Rotations Commands](#rotations-commands)
    - [`rot() { ... }`](#rot---)
    - [`xrot() { ... }`](#xrot---)
    - [`yrot() { ... }`](#yrot---)
    - [`zrot() { ... }`](#zrot---)
...
- [Scaling Commands](#scaling-commands)
    ...
    - [`yscale() { ... }`](#yscale---)
    - [`zscale() { ... }`](#zscale---)
- [Mirroring Commands](#mirroring-commands)
    - [`xflip() { ... }`](#xflip---)
    - [`yflip() { ... }`](#yflip---)
    - [`zflip() { ... }`](#zflip---)
...
- [Skew Commands](#skew-commands)
    - [`xskew() { ... }, skew_yz() { ... }`](#xskew----skew_yz---)
    - [`yskew() { ... }, skew_xz() { ... }`](#yskew----skew_xz---)
    - [`zskew() { ... }, skew_xy() { ... }`](#zskew----skew_xy---)
